    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default" >
                ...
                <!-- /.card-header -->
            <form action="?c=categories&a=create" method="post">
                <div class="col-md-10">
                    <label>نام دسته بندی</label>
                    <input name="title" type="text" class="form-control my-colorpicker1" required>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <select name="type" class="form-control select2" style="width: 100%;">
                                   ...
                                   <option value="weblog">بلاگ</option>
                                </select>
                            </div>
                            <!-- /.form-group -->
                            <div class="form-group">
                    ...
                    <input  type="submit" value="ساخت" class="btn btn-primary" ></button>
            </div>
                </form>
